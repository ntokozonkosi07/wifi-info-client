package za.co.wifi.info.service;
...
import za.co.wifi.info.controller.model.Advert;
import za.co.wifi.info.controller.model.BannerLink;
import za.co.wifi.info.controller.model.Category;
import za.co.wifi.info.controller.model.File;
import za.co.wifi.info.repository.DBOperationFailedException;
import za.co.wifi.info.repository.advert.AdvertEntity;
import za.co.wifi.info.repository.advert.AdvertRepository;
import za.co.wifi.info.repository.advert.AdvertType;
import za.co.wifi.info.repository.advert.DownloadPageEntity;
import za.co.wifi.info.repository.category.CategoryEntity;
import za.co.wifi.info.repository.category.CategoryRepository;
import za.co.wifi.info.repository.node.banner.NodeBannerEntity;
import za.co.wifi.info.repository.node.banner.NodeBannerRepository;
